...
class TXAPlayerElement extends HTMLElement {
  ...
  get duration(): number { return this._player?.duration || 0 }
  get totalFrames(): number { return this._player?.totalFrames || 0 }
  get fps(): number { return this._player?.fps || 0 }
  get width(): number { return this._player?.width || 0 }
  get height(): number { return this._player?.height || 0 }
  get currentTime(): number { return this._player?.currentTime || 0 }
  get progress(): number { return this._player?.progress || 0 }
  get paused(): boolean { return !this._player?.isPlaying }
  get ended(): boolean { return this._player ? this._player.currentFrame >= this._player.totalFrames - 1 : false }
  ...
  get renderScale(): number { return this._player?.renderScale || 1.0 }
  set renderScale(value: number) {
    this.setAttribute('render-scale', String(value))
  }

  get changeSpeed(): number { return this._player?.changeSpeed || 2.0 }
