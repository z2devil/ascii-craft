...
export class TXADecoder {
  ...
  get width(): number { return this.header?.width || 0 }
  get height(): number { return this.header?.height || 0 }
  get fps(): number { return this.header?.fps || 30 }
  get totalFrames(): number { return this.frames.length }
  get colorMode(): number { return this.header?.colorMode || 0 }
  get duration(): number { return this.totalFrames / this.fps }
  get bgColor(): RGB { return this.header?.bgColor || [0, 0, 0] }
  get changeSpeed(): number { return this.header?.changeSpeed || 2.0 }
  get canvasRatio(): number { return this.header?.canvasRatio || 0 }
}
