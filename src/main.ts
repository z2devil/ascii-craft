...
class ASCIICraft {
  ...
  updateMediaPlane() {
    ...
    if (this.mediaPlane) {
      ...
      if (Array.isArray(this.mediaPlane.material)) {
        this.mediaPlane.material.forEach(m => m.dispose())
      } else {
  ...
  setupControls() {
    ...
    canvasRatioSelect.addEventListener('change', (e) => {
      this.canvasRatio = parseInt((e.target as HTMLSelectElement).value)
    ...
    bgCharInput.addEventListener('change', () => {
      this.asciiEffect.setCharacters((bgCharInput as HTMLInputElement).value, (patternCharsInput as HTMLInputElement).value)
    })
  ...
  setupRecordingControls() {
    ...
    if (lumBitsSelect) {
      lumBitsSelect.addEventListener('change', (e) => {
        lumBits = parseInt((e.target as HTMLSelectElement).value)
      })
    }
