...
function createCharacterTexture(characters, cellSize, fontFamily) {
...
export class ASCIIEffect extends Effect {
  ...
  get colorMode() {
    return this.uniforms.get('uColorMode').value
  }
  
  set colorDark(value) {
    this.uniforms.get('uColorDark').value.set(value)
  }
  
  set colorLight(value) {
    this.uniforms.get('uColorLight').value.set(value)
  }
  
  set bgColor(value) {
    this.uniforms.get('uBgColor').value.set(value)
  }
  ...
  get hueShift() {
    return this.uniforms.get('uHueShift').value
  }
  ...
  get saturation() {
    return this.uniforms.get('uSaturation').value
  }
  ...
  get changeSpeed() {
    return this.uniforms.get('uChangeSpeed').value
  }
  
  set inputBlack(value) {
    this.uniforms.get('uInputBlack').value = value
  }
  
  get inputBlack() {
    return this.uniforms.get('uInputBlack').value
  }
  
  set inputWhite(value) {
    this.uniforms.get('uInputWhite').value = value
  }
  
  get inputWhite() {
    return this.uniforms.get('uInputWhite').value
  }
  ...
  get gamma() {
    return this.uniforms.get('uGamma').value
  }
  ...
  setCharacters(backgroundChar, patternChars) {
    this._backgroundChar = backgroundChar
    this._patternChars = patternChars
    this._regenerateTexture()
  }
