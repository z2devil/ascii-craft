import { TXAEncoder, type EncoderStats, type GridData } from './TXAEncoder'
...
export class ASCIIRecorder {
  ...
  extractGridData(pixelData: Uint8Array, canvasWidth: number, canvasHeight: number, gridWidth: number, gridHeight: number, cellSize: number): GridData {
    const grid: GridData = []
